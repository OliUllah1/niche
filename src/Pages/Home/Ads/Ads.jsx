        ...
        <img className='w-72' src={img} alt="" />
            ...
            <div>
                ...
                <p className='text-center text-[#102f25] text-lg'>Tell us what matters most to you and we'll create a <br className='hidden lg:block' />  custom list of schools tailored to fit your needs.</p>
                 ...
                 <button className='w-64 font-semibold text-lg text-white rounded-sm py-3 bg-[#237c3a]'>Take our College Quiz</button>
                 </div>
                 <div className='flex justify-center my-5'>
                 <button className='w-64 font-semibold text-lg text-white rounded-sm py-3 bg-[#237c3a]'>Find K-12 Schools Near You</button>
                 </div>
