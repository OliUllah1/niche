    ...
    return (
        ...
        <div className='lg:px-40 px-10 py-20 lg:flex'>
            ...
            <div className='w-full relative'>
                ...
                <img className='lg:w-80 w-52 h-60 lg:h-80 object-cover rounded-xl' src={dartmouth} alt="" data-aos="fade-down"
     data-aos-easing="linear" />
                <img className='lg:w-80 w-52 rounded-xl absolute -bottom-24 right-0' src={nazareth} alt="" data-aos="fade-up" />
