...
const Navbar = () => {
    return (
        <div className='px-2 lg:px-10 py-3 flex items-center justify-between'>
            ...
            <div className=' w-40'><a title="Niche" href="https://www.niche.com/" data-after-sherlock="true" aria-label="Niche Home"><svg class="" viewBox="0 0 572 112" xmlns="http://www.w3.org/2000/svg">
...
<path fill="#237c3a" d="M187 52.5h50v7h-50zm119.5 29H269v-22h31c3 0 4.3-1.7 4.3-3.5 0-1.6-1.2-3.4-4.4-3.4H269V31h37.5c3.1 0 4.2-1.8 4.2-3.6 0-1-.4-3.3-4.2-3.3h-41.1c-2.6 0-4.2 1.5-4.2 4.2v56.1c0 2.7 1.2 3.9 3.9 3.9h41.4c2.6 0 4.2-1.3 4.2-3.6.1-1.9-1.5-3.2-4.2-3.2z"></path>
            ...
            <div className='flex gap-3'>
                <button className='text-2xl pr-5 text-[#298541] border-r-[2px] border-[#9ad1a8]'><FaSearch></FaSearch></button>
                <button className='border-[2px] text-base rounded-sm font-semibold border-[#298541] px-3 py-1 text-[#298541]'>Log In</button>
                <button className='text-base font-semibold bg-[#298541] px-3 py-1 text-white rounded-sm'>Sign Up</button>
            </div>
        </div>
    );
};
