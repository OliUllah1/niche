...
const Banner = () => {
    return (
        <div className='lg:flex'>
            <div className='w-full h-full lg:h-[550px]'>
            ...
            <div className='w-full bg-[#102f25] text-white lg:px-20 px-3 lg:py-10 py-5'>
                <h3 className='lg:mb-3 mb-2 lg:mt-7 text-lg lg:text-xl text-center font-medium tracking-[4px]'>FIND THE SCHOOL</h3>
                ...
                <h3 className='font-semibold text-center tracking-[3px]'>START YOUR SEARCH</h3>
                <div className='lg:flex space-y-5 lg:space-y-0 px-28 lg:px-0 pb-20 lg:pb-0 mt-4 items-center justify-between  gap-6'>
