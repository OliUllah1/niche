    ...
    return (
        <div className='px-10 py-20 lg:flex gap-10 relative'>
            ...
            <div className='w-full mt-10'>
                ...
                <div className='lg:px-20 px-10 mt-10 py-5 relative'>
                    <img className='lg:w-14 w-10 absolute left-0 -top-3 lg:left-6' src={quoteLeft} alt="" />
                    <img className='lg:w-16 w-12 absolute bottom-12 lg:bottom-14 right-0 lg:right-12' src={quoteRight} alt="" />
